...
{
    [Activity(Label = "Project 4", MainLauncher = true, Icon = "@drawable/IconProject")]
...

    {
        ...
        protected override void OnCreate(Bundle bundle)
        {
            ...
            Button3 = FindViewById<Button>(Resource.Id.ButtonMyLocation);

            mButton.Click += mButton_Click;
            Button1.Click += Button1_Click;
            Button2.Click += mButton2_Click;
            Button3.Click += mButton3_Click;
        ...
        {
            Intent intent = new Intent(this, typeof(CurrentLocationActivity));
