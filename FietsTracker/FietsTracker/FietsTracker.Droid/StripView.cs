...
namespace FietsTracker.Droid
{
    ...
    public class StripView : LinearLayout
    {
        ...
        private int[] INDICATOR_COLORS = { 0x4DB0DA };
        ...
        //Tab colorizer
        private ScrollView.TabColorizer mCustomTabColorizer;
        private SimpleTabColorizer mDefaultTabColorizer;
        //Stop copy and paste here........................................................................

        //Constructors
        public StripView(Context context) : this(context, null)
        { }

        public StripView(Context context, IAttributeSet attrs) : base(context, attrs)
        {
        ...
        public ScrollView.TabColorizer CustomTabColorizer
        {
            set
            {
        ...
        protected override void OnDraw(Canvas canvas)
        {
            ...
            ScrollView.TabColorizer tabColorizer = mCustomTabColorizer != null ? mCustomTabColorizer : mDefaultTabColorizer;
        ...
        private class SimpleTabColorizer : ScrollView.TabColorizer
        {
